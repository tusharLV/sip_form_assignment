const text = {
  ...
  SIP_scheme_Input_helper:
    'Start by setting up a SIP in a scheme of your choice. Remember you cannot choose ELSS or Target Maturity Funds for Future Ready SIP',
  SIP_amount_label: 'SIP Amount',
  SIP_amount_input_helper: 'Select the scheme and amount',
  SIP_start_date_input_helper:
    'Choose the start date and duration. Frequency will be monthly.\n' +
    '                        The selected duration will determine the date of the last SIP.',
  next: 'Next',
  SIP_top_up_input_helper:
    'Next, decide if you want to Top-up your SIP. If yes, mention your top-up amount, frequency and the maximum top-up amount',
  ...
  SWP_switch_notice:
    'Your entire investment amount (all units) will be switched to this scheme 15 days after your last SIP installment date.',
  button_promotion: 'Be Future Ready by starting a SIP today and planning your SWP for future',
  switch_date_label: 'Switch Date',
  SWP_scheme_input_helper:
    'Now choose if your SWP should be from the same scheme as your SIP or from another scheme. If you choose another scheme, a one time switch of your entire investment amount (all units) will occur in 15 days of your last SIP date.',
  SWP_frequency_label: 'Frequency',
  SWP_amount_input_helper:
    'Select the SWP amount - Choose from the recommended amount or enter your own amount',
